...
const paragraphs = [
    ...
    "JЯ впевнена, що найкращий спосіб вивчення мови - це поєднання навчання з приємністю. У мене є досвід роботи як у групах, так і проведення індивідуальних занять: від початкового рівня до поглибленого рівня B2. Я також вела розмовні клуби, завдяки яким вже 22 особи розмовляють польською мовою. ",

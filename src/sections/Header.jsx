...
function Header() {
  return (
    <header>
      <Navbar/>
      <div className='container mx-auto md:px-4 bg-primary-25 auto h-screen md:h-[500px] py-10 px-5 xl:px-0 mb-12 md:mb-24 rounded-basic flex flex-col justify-evenly md:justify-center'>
